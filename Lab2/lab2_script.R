...
d <- matrix(c(3000, 1408, 2490, 1029, 1641, 1349, 1624, 1539, 1899, 2071, 1244, 1299, 2260, 1505, 1819, 180, 190, 149, 170, 171, 149, 122, 177, 200, 162, 190, 220, 189, 165, 219, 70, 94, 69, 84, 73, 89, 91, 99, 65, 80, 91, 79, 83, 72, 95, 100, 95),nrow = 15,ncol = 3)
w <- c(0.3, 0.3, 0.4)
cb <- c('min','max','min')
v <- 0.5
VIKOR(d,w,cb,v)